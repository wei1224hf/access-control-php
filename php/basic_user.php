...
class basic_user {
	...
	public static function callFunction(){
		...
		else if($function =="add_register"){
			$t_return = basic_user::add_register();
		}
	...
	private static function _login(
		...
		session_start();
		$_SESSION = $t_return;
		$_SESSION['users'] = $t_return['logindata'];
		if(isset($_REQUEST['return_array'])){
			$t_return = array($t_return);
		}
		return $t_return;
	}
	...
	public static function add_register(){
	    ...
	    $data = array(
	        ...
	        ,'money'=>100
	        ,'group_code'=>tools::getConfigItem("REGISTERED_GROUP")
	        ,'id'=> ( tools::getTableId("basic_user")+1 )
	        ,'type'=>10
	    	,'status'=>10
	    	,'credits'=>10
	    );
